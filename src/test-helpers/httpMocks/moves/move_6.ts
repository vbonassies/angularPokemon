export const pokemon_moves_6 = {
    "accuracy": 100,
    "contest_combos": null,
    "contest_effect": {"url": "https://pokeapi.co/api/v2/contest-effect/11/"},
    "contest_type": {"name": "smart", "url": "https://pokeapi.co/api/v2/contest-type/4/"},
    ...
    "flavor_text_entries": [{
        ...
        "flavor_text": "Das Ziel wird mit Münzen beworfen.\nDas Geld wird nach dem Kampf aufgesammelt.",
        "language": {"name": "de", "url": "https://pokeapi.co/api/v2/language/6/"},
        "version_group": {"name": "omega-ruby-alpha-sapphire", "url": "https://pokeapi.co/api/v2/version-group/16/"}
    }, {
        "flavor_text": "Des pièces sont lancées sur l’ennemi.\nPermet d’obtenir de l’argent à la fin du combat.",
        ...
        "flavor_text": "Arroja monedas al objetivo. Las recupera al final\ndel combate.",
        "language": {"name": "es", "url": "https://pokeapi.co/api/v2/language/7/"},
        "version_group": {"name": "x-y", "url": "https://pokeapi.co/api/v2/version-group/15/"}
    }, {
        "flavor_text": "Das Ziel wird mit Münzen beworfen.\nDas Geld wird nach dem Kampf aufgesammelt.",
        ...
        "flavor_text": "Numerous coins are\nhurled at the foe to\ninflict damage.\nMoney is earned\nafter battle.",
        "language": {"name": "en", "url": "https://pokeapi.co/api/v2/language/9/"},
        ...
        "flavor_text": "Throws coins at the foe.\nMoney is recovered after.",
        "language": {"name": "en", "url": "https://pokeapi.co/api/v2/language/9/"},
    ...
    "id": 6,
    "machines": [{
        "machine": {"url": "https://pokeapi.co/api/v2/machine/271/"},
        "version_group": {"name": "red-blue", "url": "https://pokeapi.co/api/v2/version-group/1/"}
    }, {
        "machine": {"url": "https://pokeapi.co/api/v2/machine/272/"},
    ...
    "names": [{
        ...
        "language": {"name": "ko", "url": "https://pokeapi.co/api/v2/language/3/"},
        "name": "고양이돈받기"
    }, {"language": {"name": "ja-Hrkt", "url": "https://pokeapi.co/api/v2/language/1/"}, "name": "ネコにこばん"}],
    "past_values": [],
    "power": 40,
    "pp": 20,
    "priority": 0,
    "stat_changes": [],
    "super_contest_effect": {"url": "https://pokeapi.co/api/v2/super-contest-effect/23/"},
