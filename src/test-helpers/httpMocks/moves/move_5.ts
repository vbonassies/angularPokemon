export const pokemon_moves_5 = {
    ...
    "contest_combos": {
        "normal": {
            ...
            }, {"name": "mind-reader", "url": "https://pokeapi.co/api/v2/move/170/"}], "use_before": null
    ...
    "machines": [{
        ...
        "machine": {"url": "https://pokeapi.co/api/v2/machine/2/"},
    ...
    "names": [{
        ...
        "language": {"name": "ko", "url": "https://pokeapi.co/api/v2/language/3/"},
        "name": "메가톤펀치"
    }, {"language": {"name": "ja-Hrkt", "url": "https://pokeapi.co/api/v2/language/1/"}, "name": "メガトンパンチ"}],
    "past_values": [],
    "power": 80,
    "pp": 20,
    "priority": 0,
    "stat_changes": [],
    "super_contest_effect": {"url": "https://pokeapi.co/api/v2/super-contest-effect/18/"},
