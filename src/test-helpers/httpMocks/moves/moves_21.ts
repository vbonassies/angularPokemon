export const pokemon_moves_21 = {
    "accuracy": 75,
    "contest_combos": {
        "normal": {
            "use_after": [{"name": "focus-energy", "url": "https://pokeapi.co/api/v2/move/116/"}],
            "use_before": null
        }, "super": {"use_after": null, "use_before": null}
    },
    "contest_effect": {"url": "https://pokeapi.co/api/v2/contest-effect/23/"},
    ...
    "flavor_text_entries": [{
        ...
        "flavor_text": "The target is slammed with a long tail,\nvines, or the like to inflict damage.",
        "language": {"name": "en", "url": "https://pokeapi.co/api/v2/language/9/"},
        "version_group": {"name": "omega-ruby-alpha-sapphire", "url": "https://pokeapi.co/api/v2/version-group/16/"}
    }, {
        "flavor_text": "Infligge danni al bersaglio con la coda, con una\nliana o simili.",
        ...
        "flavor_text": "Golpea con las extremidades.",
        "language": {"name": "es", "url": "https://pokeapi.co/api/v2/language/7/"},
        "version_group": {"name": "omega-ruby-alpha-sapphire", "url": "https://pokeapi.co/api/v2/version-group/16/"}
    }, {
        "flavor_text": "Schlag mit einem langen Schweif, einer Ranke\noder Ähnlichem.",
        "language": {"name": "de", "url": "https://pokeapi.co/api/v2/language/6/"},
        "version_group": {"name": "omega-ruby-alpha-sapphire", "url": "https://pokeapi.co/api/v2/version-group/16/"}
    }, {
        "flavor_text": "Fouette l’ennemi avec la queue ou une liane,\npar exemple, pour infliger des dégâts.",
        ...
        "flavor_text": "Fouette l’ennemi avec la queue, une\nliane, etc. pour infliger des dégâts.",
        "language": {"name": "fr", "url": "https://pokeapi.co/api/v2/language/5/"},
        "version_group": {"name": "black-white", "url": "https://pokeapi.co/api/v2/version-group/11/"}
    }, {
        "flavor_text": "The foe is slammed\nwith a long tail,\nvines, etc., to inflict\ndamage.\n",
        "language": {"name": "en", "url": "https://pokeapi.co/api/v2/language/9/"},
        ...
        "flavor_text": "Slams the foe with\na tail, vine, etc.",
        "language": {"name": "en", "url": "https://pokeapi.co/api/v2/language/9/"},
    ...
    "names": [{
        ...
        "language": {"name": "ko", "url": "https://pokeapi.co/api/v2/language/3/"},
        "name": "힘껏치기"
    }, {"language": {"name": "ja-Hrkt", "url": "https://pokeapi.co/api/v2/language/1/"}, "name": "たたきつける"}],
    "past_values": [],
    "power": 80,
    "pp": 20,
    "priority": 0,
